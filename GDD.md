...
10. **Changelog e strumenti di sviluppo** (idee 39, 40) — nelle impostazioni: **changelog delle versioni** con le implementazioni e i fix di ciascuna; sezione di sviluppo con **+1000 lingotti di ferro**, **+1000 lingotti di rame**, **+1000 Cookie**; e un **"finisci subito"** su tutte le azioni a tempo (costruzione dei moduli, viaggi), per testare i contenuti tardivi senza ricominciare da capo
