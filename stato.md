...
- **Idee 39-40 registrate** (25/07, direttiva): **changelog delle versioni** e **strumenti di sviluppo** (risorse a comando + "finisci subito" su costruzioni e viaggi) nelle impostazioni — nuova **tappa 4** della roadmap, subito dopo la mappa a sistemi solari. Tre punti restano aperti (vedi [idee.md](idee.md)): se gli strumenti stiano dietro una "modalità sviluppatore", se il "finisci subito" sia un tasto unico o uno per barra di progresso, e se i lingotti di rame arrivino anche senza fonderia Lv 2
...
4. **Changelog e strumenti di sviluppo** (idee 39-40, direttiva del 25/07): tasto **changelog** nelle impostazioni (una voce per versione, implementazioni e fix in breve, compilata a ogni build); sezione di sviluppo con **+1000 lingotti di ferro**, **+1000 lingotti di rame**, **+1000 Cookie**; **"finisci subito"** su ogni azione a tempo — costruzione dei moduli e viaggi. Motivo: provare i contenuti tardivi senza ricominciare da zero e senza aspettare i timer reali
