...
1. ~~**Rifiniture di interfaccia e comandi**~~ ✓ (26/07, idee 43-48) — **in attesa di build**: la v0.12 va pubblicata su richiesta, e prima serve la voce nel [changelog](changelog.md). Da guardare al playtest: i costi nella nuova lettura, il pinch sulla mappa, il giro fonderia → POTENZIAMENTI → indietro, e il focus dell'IA in un campo misto
