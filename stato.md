...
4. **Silicio, titanio, alluminio** coi Mk successivi (pesi crescenti), nuovi campi e nuove ricette — il ciclo "a mano prima, automatico poi" è già pronto ad accoglierli
5. **Altre stazioni** come checkpoint con gate di teletrasporto (nel grafo: archi speciali) e milestone successive; **intro a fumetto**; l'**universo 2** come capitolo massimo
6. **Milestone "Relitti"**: relitti di stazione esplorabili con minigioco, HP della tuta ed equipaggiamento — dopo tutto il resto
